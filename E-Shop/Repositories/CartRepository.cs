...
namespace E_Shop.Repositories
{
    public class CartRepository : ICartRepository
    {
        ...
        public async Task<int> AddItem(int clothingId, int qty)
        {
            ...
            try
            {
                ...
                var cartItem = _db.CartDetails
                                .FirstOrDefault(a => a.ShoppingCartId == cart.Id && a.ClothingId == clothingId);
                ...
                {
                    var book = _db.Clothings.Find(clothingId);
        ...
        public async Task<int> RemoveItem(int clothingId)
        {
            //using var transaction = _db.Database.BeginTransaction();
            string userId = GetUserId();
            try
        ...
        public async Task<bool> DoCheckout(CheckoutModel model)
        {
            ...
            try
            {
                ...
                foreach(var item in cartDetail)
                {
                    ...
                    var stock = await _db.Stocks.FirstOrDefaultAsync(a => a.ClothingId == item.ClothingId);
                    if (stock == null)
                    {
